...
function Counter({ fontStyles, ReactLogo }) {
  ...
  const reset = () => {
    ...
    return (
        <>
            <CardHeader><ReactLogo />C<span style={fontStyles}>o</span><span style={fontStyles}>u</span>nt<span style={fontStyles}>e</span>r<ReactLogo /></CardHeader>
            <CardBody>
