...
function AccordianComponent({ fontStyles, ReactLogo }) {
    ...
    return(
        <>
            <CardHeader><ReactLogo />Ac<span style={fontStyles}>cord</span>ian compo<span style={fontStyles}>ne</span >n<span style={fontStyles}>t</span><ReactLogo /></CardHeader>
