    ...
    return (
        <Container>
            <Row>
                ...
                <Col sm="6" md="4" xl="6">
                    <Card style={bgStyles}>
                        <Counter fontStyles={fontStyles} logo={logo} />
                    </Card>
                </Col>
                {/* ======== Color Picker ======== */}
                <Col sm="6" md="4" xl="6">
                    <Card style={bgStyles}>
                        <ColorPicker color={color} setColor={setColor} fontStyles={fontStyles} logo={logo} />
                    </Card>
                </Col>
                {/* ======== Hide Element ======== */}
                <Col sm="6" md="4" xl="6">
                    <Card style={{ background: star ? randomColor : "pink", }} >
                        <HideElement star={star} setStar={setStar} fontStyles={fontStyles} logo={logo} />
                    </Card>
                </Col>
                {/* ======== Random Color ======== */}
                <Col sm="6" md="4" xl="6">
                    <Card style={bgStyles}>
                        <RandomColor randomColor={randomColor} changeColor={changeColor} fontStyles={fontStyles} logo={logo} />
                    </Card>
                </Col>
                {/* ======== User Props ======== */}
                <Col sm="6" md="4" xl="6">
                    <Card style={bgStyles}>
                        <UserProps randomColor={randomColor} fontStyles={fontStyles} logo={logo} />
                    </Card>
                </Col>
                {/* ======== Input Value ======== */}
                <Col sm="6" md="4" xl="6">
                    <Card style={bgStyles}>
                        <InputValue randomColor={randomColor} fontStyles={fontStyles} logo={logo} />
                    </Card>
                </Col>
                {/* ======== Ghibli API ======== */}
                <Col sm="6" md="4" xl="6">
                    <Card style={bgStyles} className="ghibli-api">
                        <GhibliApi fontStyles={fontStyles} logo={logo} />
                    </Card>
                </Col>
                {/* ======== Dog API ======== */}
                <Col sm="6" md="4" xl="6">
                    <Card className='dog-api' style={bgStyles} id="dog-api">
                        <DogApi fontStyles={fontStyles} logo={logo} />
                    </Card>
                </Col>
                {/* ======== Rick and Morty API ======== */}
                <Col sm="6" md="4" xl="6">
                    <Card style={bgStyles} className="rick-and-morty-api">
                        <RickAndMortyApi fontStyles={fontStyles} logo={logo}/>
                    </Card>
                </Col>
                {/* ======== Nasa API ======== */}
                <Col sm="6" md="4" xl="6">
                    <Card style={bgStyles} className="nasa-api">
                        <NasaApi fontStyles={fontStyles} logo={logo} />
                    </Card>
                </Col>
                {/* ======== Friends Form ======== */}
                <Col sm="6" md="4" xl="6">
                    <Card style={bgStyles} className="friends-form">
                        <FriendsForm fontStyles={fontStyles} logo={logo} />
                    </Card>
                </Col>
                {/* ======== Advanced Form ======== */}
                <Col sm="6" md="4" xl="6">
                    <Card style={bgStyles} className="friends-form">
                        <AdvancedForm fontStyles={fontStyles} logo={logo} />
                    </Card>
                </Col>
                {/* ======== Class Component Form ======== */}
                <Col sm="6" md="4" xl="6">
                    <Card style={bgStyles} className="friends-form">
                        <ClassComponentForm logo={logo} />
                    </Card>
                </Col>
                {/* ======== Accordian Component ======== */}
                <Col sm="6" md="4" xl="6">
                    <Card style={bgStyles} className="accordian-component">
                        <AccordianComponent fontStyles={fontStyles} logo={logo} />
                    </Card>
                </Col>
                {/* ======== Random RGB ======== */}
                <Col sm="6" md="4" xl="6">
                    <Card style={bgStyles} className="random-rgb-color">
                        <RandomRgbColors fontStyles={fontStyles} logo={logo} />
                    </Card>
                </Col>
                {/* ======== Ratings Component ======== */}
                <Col sm="6" md="4" xl="6">
